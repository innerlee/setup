...
#                                  说明
#
# 本脚本用于安装ffmpeg包含10bit版本，支持sony xvac intra-50/100/200/300/480 格式
# NOTE:
#     1. 需要x264_xavc-sony(branch: master)和ffmpeg_xavc-sony(branch: n3.4.8_xavc-sony)
#        Repo的权限，可向duanjiaqi申请
#     2. 需要其他依赖支持，安装步骤会持续【-24 ---> 00】,如果中断请查看相关log
#     3. 本脚本每次都会重头开始安装....
##################################################################################i#####
