...
# install yasm
echo -e "\033[32m[-9]>>> install yasm... \033[0m"
cd ../yasm-1.3.0
SHELL_FOLDER=$(dirname $(readlink -f "$0"))
echo "      >>> configure...     [log > "$SHELL_FOLDER/log_configure.txt ]
./configure --prefix=$ROOTDIR > log_configure.txt 2>&1
...
# install libvpx
echo -e "\033[32m[-8]>>> install libvpx... \033[0m"
cd ../libvpx-master
SHELL_FOLDER=$(dirname $(readlink -f "$0"))
echo "      >>> configure...     [log > "$SHELL_FOLDER/log_configure.txt ]
./configure --prefix=$ROOTDIR > log_configure.txt 2>&1
...
# install libass
echo -e "\033[32m[-7]>>> install libass... \033[0m"
cd ../libass-0.13.2
SHELL_FOLDER=$(dirname $(readlink -f "$0"))
echo "      >>> configure...     [log > "$SHELL_FOLDER/log_configure.txt ]
./configure --prefix=$ROOTDIR > log_configure.txt 2>&1
...
# install libiconv
echo -e "\033[32m[-6]>>> install libiconv... \033[0m"
cd ../libiconv-1.14
...
# install lame
echo -e "\033[32m[-5]>>> install lame... \033[0m"
cd ../lame-3.99.5
SHELL_FOLDER=$(dirname $(readlink -f "$0"))
echo "      >>> configure...     [log > "$SHELL_FOLDER/log_configure.txt ]
./configure --prefix=$ROOTDIR > log_configure.txt 2>&1
...
# install freetype
echo -e "\033[32m[-4]>>> install freetype... \033[0m"
cd ../freetype-2.6.2
SHELL_FOLDER=$(dirname $(readlink -f "$0"))
echo "      >>> configure...     [log > "$SHELL_FOLDER/log_configure.txt ]
./configure --prefix=$ROOTDIR > log_configure.txt 2>&1
...
# install fontconfig
echo -e "\033[32m[-3]>>> install fontconfig... \033[0m"
...
# install x264
echo -e "\033[32m[-2]>>> install x264... \033[0m"
...
# install x265
echo -e "\033[32m[-1]>>> install x265... \033[0m"
cd ../x264-snapshot-20160319-2245-stable/build
SHELL_FOLDER=$(dirname $(readlink -f "$0"))
echo "      >>> camke...         [log > "$SHELL_FOLDER/log_camke.txt ]
camke ../source/ > log_camke.txt 2>&1
echo "      >>> make...          [log > "$SHELL_FOLDER/log_make.txt ]
make -j 4 > log_make.txt 2>&1
echo "      >>> make install...  [log > "$SHELL_FOLDER/log_make_install.txt ]
...
# install ffmpeg
echo -e "\033[32m[0]>>> install ffmpeg... \033[0m"
cd ../../ffmpeg
SHELL_FOLDER=$(dirname $(readlink -f "$0"))
echo "      >>> configure...     [log > "$SHELL_FOLDER/log_configure.txt ]
